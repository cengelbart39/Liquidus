...
class IntentLogic {
    static func filterDataByDay(day: Date, data: DrinkData) -> [Drink] {
        ...
        static func getTotalPercent(date: Date, data: DrinkData) -> Double {
            
            // Get total amount
            let totalAmount = IntentLogic.getTotalAmount(date: date, data: data)
        ...
        static func getTotalPercent(week: [Date], data: DrinkData) -> Double {
            
            // Get the total amount
            let totalAmount = IntentLogic.getTotalAmount(week: week, data: data)
