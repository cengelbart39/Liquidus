...
class DMDataByHalfYearTests: XCTestCase {
    ...
    func testGetHalfYear() {
        ...
        let result = model.getHalfYear(date: testDate)
        ...
        for i1 in 0..<expected.count {
            ...
            for i2 in 0..<expected[i1].count {
                ...
                XCTAssertEqual(result[i1][i2], expected[i1][i2], "at i1 \(i1), i2 \(i2)")
            }
        }
    }
    ...
    func testFilterByHalfYear() {
        ...
        let prev6Months = model.getHalfYear(date: Calendar.current.date(from: DateComponents(year: 2021, month: 10, day: 1))!)
     ...
     */
    private func halfYearFromApril2022() -> [[Date]] {
        var w1 = model.getWeek(date: Calendar.current.date(from: DateComponents(year: 2021, month: 11, day: 1))!)
        w1.removeFirst()
        
        let w2 = model.getWeek(date: Calendar.current.date(from: DateComponents(year: 2021, month: 11, day: 7))!)

        let w3 = model.getWeek(date: Calendar.current.date(from: DateComponents(year: 2021, month: 11, day: 14))!)

        let w4 = model.getWeek(date: Calendar.current.date(from: DateComponents(year: 2021, month: 11, day: 21))!)

        let w5 = model.getWeek(date: Calendar.current.date(from: DateComponents(year: 2021, month: 11, day: 28))!)

        let w6 = model.getWeek(date: Calendar.current.date(from: DateComponents(year: 2021, month: 12, day: 5))!)

        let w7 = model.getWeek(date: Calendar.current.date(from: DateComponents(year: 2021, month: 12, day: 12))!)

        let w8 = model.getWeek(date: Calendar.current.date(from: DateComponents(year: 2021, month: 12, day: 19))!)

        let w9 = model.getWeek(date: Calendar.current.date(from: DateComponents(year: 2021, month: 12, day: 26))!)

        let w10 = model.getWeek(date: Calendar.current.date(from: DateComponents(year: 2022, month: 1, day: 2))!)

        let w11 = model.getWeek(date: Calendar.current.date(from: DateComponents(year: 2022, month: 1, day: 9))!)

        let w12 = model.getWeek(date: Calendar.current.date(from: DateComponents(year: 2022, month: 1, day: 16))!)

        let w13 = model.getWeek(date: Calendar.current.date(from: DateComponents(year: 2022, month: 1, day: 23))!)

        let w14 = model.getWeek(date: Calendar.current.date(from: DateComponents(year: 2022, month: 1, day: 30))!)

        let w15 = model.getWeek(date: Calendar.current.date(from: DateComponents(year: 2022, month: 2, day: 6))!)

        let w16 = model.getWeek(date: Calendar.current.date(from: DateComponents(year: 2022, month: 2, day: 13))!)

        let w17 = model.getWeek(date: Calendar.current.date(from: DateComponents(year: 2022, month: 2, day: 20))!)

        let w18 = model.getWeek(date: Calendar.current.date(from: DateComponents(year: 2022, month: 2, day: 27))!)

        let w19 = model.getWeek(date: Calendar.current.date(from: DateComponents(year: 2022, month: 3, day: 6))!)

        let w20 = model.getWeek(date: Calendar.current.date(from: DateComponents(year: 2022, month: 3, day: 13))!)

        let w21 = model.getWeek(date: Calendar.current.date(from: DateComponents(year: 2022, month: 3, day: 20))!)

        let w22 = model.getWeek(date: Calendar.current.date(from: DateComponents(year: 2022, month: 3, day: 27))!)

        let w23 = model.getWeek(date: Calendar.current.date(from: DateComponents(year: 2022, month: 4, day: 3))!)

        let w24 = model.getWeek(date: Calendar.current.date(from: DateComponents(year: 2022, month: 4, day: 10))!)

        let w25 = model.getWeek(date: Calendar.current.date(from: DateComponents(year: 2022, month: 4, day: 17))!)

        let w26 = model.getWeek(date: Calendar.current.date(from: DateComponents(year: 2022, month: 4, day: 24))!)
